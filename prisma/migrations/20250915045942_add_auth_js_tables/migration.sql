/*
  ...
  - You are about to drop the column `userId` on the `UserScore` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "UserScore_userId_idx";
...
-- CreateIndex
CREATE INDEX "UserScore_user_id_idx" ON "UserScore"("user_id");
...
-- AddForeignKey
ALTER TABLE "UserScore" ADD CONSTRAINT "UserScore_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
